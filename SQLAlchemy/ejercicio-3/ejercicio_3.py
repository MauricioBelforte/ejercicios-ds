"""
Ejercicio 3 — Navegación bidireccional

Actualizar la relación en `Profesor` para que, desde una instancia de
profesor, se pueda acceder directamente a su departamento
(`profesor.departamento`).

Insertar un departamento con tres profesores y verificar la navegación en
ambos sentidos.
"""
...
if __name__ == "__main__":
    ...
    with Session(engine) as session:
        ...
        for prof in profesores:
            # Accedemos directamente a la propiedad .departamento desde el profesor
            nombre_depto = prof.departamento.nombre if prof.departamento else "Sin Asignar"
            print(f"Profesor: {prof.nombre} | Pertenece al Departamento: {nombre_depto}")
